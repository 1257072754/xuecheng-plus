...
public class CourseBaseInfoController {
    ...
    public PageResult<CourseBase> list(PageParams pageParams, @RequestBody(
            required = false) QueryCourseParamsDto queryCourseParamsDto) {
    ...
    public CourseBaseInfoDto queryCourseInfoById(@PathVariable Long id){
        return courseBaseInfoService.queryCourseInfoById(id);
    }
    @ApiOperation("编辑课程信息")
    @PutMapping("/course")
    public CourseBaseInfoDto updateCourseInfo(@RequestBody @Validated(ValidationGroups.Update.class) EditCourseDto editCourseDto){
        return courseBaseInfoService.updateCourseInfo(1232141425L,editCourseDto);
    }
}
